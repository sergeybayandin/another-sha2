...
Sha384::Sha384() noexcept
    : state_engine_(hidden::common::sha384_initializers)
{}

Sha384::OutputHash Sha384::finalize() noexcept {
    ...
    state_engine_.initialize_with(hidden::common::sha384_initializers);
